...
class users extends DatabaseObject {
  ...
  static protected $db_columns = ['id_usr', 'first_name_usr', 'last_name_usr', 'email_usr', 'username_usr','user_level_usr','hashed_password_usr', 'phone_usr', 'vendor_id'];
  ...
  protected function validate() {
    ...
    if($this->password_required) {
      ...
      } elseif (!has_length($this->password_usr, array('min' => 6))) {
